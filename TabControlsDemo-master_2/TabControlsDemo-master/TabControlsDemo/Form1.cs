...
label_1:
        ...
        {
            VID = Convert.ToInt32(app_vid.Text, 16);
            GetHidDevice();
        }

        private void textBox2_TextChanged(object sender, EventArgs e)
        {
            PID = Convert.ToInt32(app_pid.Text, 16);
            GetHidDevice();
        }
        ...
        public bool GetHidDevice()
        {
            ...
            try
            {
                ...
                if (HeadsetHIDDevice != null)
                {
                    ...
                    app_vid.Text = Convert.ToString(HeadsetHIDDevice.VendorID, 16);// BootloaderHIDDevice.VendorID.ToString();
                    //textBox1.BackColor = Color.Green;//LightBlue
                    app_pid.Text = Convert.ToString(HeadsetHIDDevice.ProductID, 16);//BootloaderHIDDevice.ProductID.ToString(); 
